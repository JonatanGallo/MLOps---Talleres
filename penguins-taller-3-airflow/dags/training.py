...
from training_app.etl import store_raw_data, clear_raw_data, get_raw_data, clear_clean_data, save_clean_data, get_clean_data, get_data
...
with DAG (dag_id= "training_dag",
    ...
    t3 = PythonOperator(task_id="clear_clean_data",
                      python_callable=clear_clean_data)

    t4 = PythonOperator(task_id="save_clean_data",
                      python_callable=save_clean_data)

    t5 = PythonOperator(task_id="save_all_models",
